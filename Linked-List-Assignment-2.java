...
class Tester {
    ...
    public static void reverseList(Node current, LinkedList reversedLinkedList) {
        if (current == null) {
            return;
        }
        reverseList(current.getNext(), reversedLinkedList);
        reversedLinkedList.addAtEnd(current.getData());
    }
}
